    ...
    <div id="collapsible-accordion">
      <div className="message">
        <div className="message-header">
          ...
          <a
            href={'#collapsible-message-accordion-' + props.num}
        ...
        <div
          id={'collapsible-message-accordion-' + props.num}
          className="message-body is-collapsible"
          data-parent="collapsible-accordion"
        >
          <div className="message-body-content">
            {switches &&
              switches.map(message => (
                <div className="content">
                  <Link
                    className="navbar-item"
                    key={message}
                    to={links[message][sel]}
                  >
