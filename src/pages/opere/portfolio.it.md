...
masonry:
  photos:
    ...
    sizes: ["(min-width: 480px) 50vw,(min-width: 1024px) 33.3vw,100vw"], width: 4, height: 3, link: '/it/opere/introduzione/', alt: 'foresta', title: 'La foresta' }
    ...
    sizes: ["(min-width: 480px) 50vw,(min-width: 1024px) 33.3vw,100vw"], width: 1, height: 1, link: '/it/opere/pittura/', alt: 'fungo', title: 'Il fungo' }
    ...
    sizes: ["(min-width: 480px) 50vw,(min-width: 1024px) 33.3vw,100vw"], width: 3, height: 4, link: '/it/opere/scultura/', alt: 'lago', title: 'Il lago' }
    ...
    sizes: ["(min-width: 480px) 50vw,(min-width: 1024px) 33.3vw,100vw"], width: 3, height: 4, link: '/it/opere/performance/', alt: 'fiume', title: 'Il fiume' }
    ...
    sizes: ["(min-width: 480px) 50vw,(min-width: 1024px) 33.3vw,100vw"], width: 3, height: 4, link: '/it/opere/arte-interattiva/', alt: 'foglie', title: 'Le foglie' }
    ...
    sizes: ["(min-width: 480px) 50vw,(min-width: 1024px) 33.3vw,100vw"], width: 4, height: 3, link: '/it/opere/', alt: 'alberi', title: 'Gli alberi' }
    ...
    sizes: ["(min-width: 480px) 50vw,(min-width: 1024px) 33.3vw,100vw"], width: 3, height: 4, link: '/it/opere/', alt: 'abeti', title: 'Gli abeti' }
    ...
    sizes: ["(min-width: 480px) 50vw,(min-width: 1024px) 33.3vw,100vw"], width: 4, height: 3, link: '/it/opere/', alt: 'ghianda', title: 'La ghianda' }
    ...
    sizes: ["(min-width: 480px) 50vw,(min-width: 1024px) 33.3vw,100vw"], width: 4, height: 3, link: '/it/opere/', alt: 'strada', title: 'La strada' }
---
